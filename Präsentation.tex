...
\begin{frame}{Strömungsmechanische Mittel}
	...
	\includegraphics[width=0.85\linewidth]{Markus/Gegenstrahl}
\end{frame}
...
\begin{frame}{Mikrokonstruierte Systeme}
	\centering
	\includegraphics[width=0.6\linewidth]{Markus/Filter}\\
	\includegraphics[width=0.6\linewidth]{Markus/membran}
\end{frame}
...
\cite{Turbulentdroppletsplitting}
